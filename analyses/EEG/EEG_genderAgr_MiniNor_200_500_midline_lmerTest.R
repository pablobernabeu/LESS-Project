...
saveRDS(EEG_genderAgr_MiniNor_200_500_midline_lmerTest, 
        'analyses/EEG/results/EEG_genderAgr_MiniNor_200_500_midline_lmerTest.rds')
...
summary(EEG_genderAgr_MiniNor_200_500_midline_lmerTest, ddf = 'Satterthwaite') %>%
  saveRDS('analyses/EEG/results/Satterthwaite_summary_EEG_genderAgr_MiniNor_200_500_midline_lmerTest.rds')
...
#   saveRDS('analyses/EEG/results/Nakagawa2017_R2_EEG_genderAgr_MiniNor_200_500_midline_lmerTest.rds')
...
lme4::confint.merMod(
  ...
  saveRDS('analyses/EEG/results/confint_EEG_genderAgr_MiniNor_200_500_midline_lmerTest.rds')

# Save random effects
lme4::ranef(EEG_genderAgr_MiniNor_200_500_midline_lmerTest) %>%
  saveRDS('analyses/EEG/results/ranef_EEG_genderAgr_MiniNor_200_500_midline_lmerTest.rds')
