...
saveRDS(EEG_genderAgr_MiniNor_200_500_midline_data, 
        'data/merged data/EEG_genderAgr_MiniNor_200_500_midline_data.rds')
...
saveRDS(EEG_genderAgr_MiniNor_200_500_midline_lmerTest, 
        'EEG/analyses/results/EEG_genderAgr_MiniNor_200_500_midline_lmerTest.rds')

# Calculate p values using Satterthwaite method (Luke, 2017; 
# https://doi.org/10.3758/s13428-016-0809-y)
summary(EEG_genderAgr_MiniNor_200_500_midline_lmerTest, ddf = 'Satterthwaite') %>%
  saveRDS('EEG/analyses/results/Satterthwaite_summary_EEG_genderAgr_MiniNor_200_500_midline_lmerTest.rds')
...
#   saveRDS('EEG/analyses/results/Nakagawa2017_R2_EEG_genderAgr_MiniNor_200_500_midline_lmerTest.rds')

# Calculate 95% confidence intervals of fixed effects
lme4::confint.merMod(
  EEG_genderAgr_MiniNor_200_500_midline_lmerTest, method = 'Wald',
  ...
  saveRDS('EEG/analyses/results/confint_EEG_genderAgr_MiniNor_200_500_midline_lmerTest.rds')

# Save random effects
lme4::ranef(EEG_genderAgr_MiniNor_200_500_midline_lmerTest) %>%
  saveRDS('EEG/analyses/results/ranef_EEG_genderAgr_MiniNor_200_500_midline_lmerTest.rds')
