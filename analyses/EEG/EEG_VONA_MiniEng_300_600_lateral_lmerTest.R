...
EEG_VONA_MiniEng_300_600_lateral_data <- 
...
EEG_VONA_MiniEng_300_600_lateral_data <- EEG_VONA_MiniEng_300_600_lateral_data %>%
...
# Save data to disk
saveRDS(EEG_VONA_MiniEng_300_600_lateral_data, 
        'data/merged data/EEG_VONA_MiniEng_300_600_lateral_data.rds')

# MODEL
# Measure running time
system.time({
  
  EEG_VONA_MiniEng_300_600_lateral_lmerTest <- lmerTest::lmer(
    ...
    data = EEG_VONA_MiniEng_300_600_lateral_data,
...
lme4::confint.merMod(
  EEG_VONA_MiniEng_300_600_lateral_lmerTest, method = 'Wald',
