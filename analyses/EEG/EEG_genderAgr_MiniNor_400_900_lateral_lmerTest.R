...
saveRDS(EEG_genderAgr_MiniNor_400_900_lateral_data, 
        'data/merged data/EEG_genderAgr_MiniNor_400_900_lateral_data.rds')
...
saveRDS(EEG_genderAgr_MiniNor_400_900_lateral_lmerTest, 
        'analyses/EEG/results/EEG_genderAgr_MiniNor_400_900_lateral_lmerTest.rds')

# Calculate p values using Satterthwaite method (Luke, 2017; 
# https://doi.org/10.3758/s13428-016-0809-y)
summary(EEG_genderAgr_MiniNor_400_900_lateral_lmerTest, ddf = 'Satterthwaite') %>%
  saveRDS('analyses/EEG/results/Satterthwaite_summary_EEG_genderAgr_MiniNor_400_900_lateral_lmerTest.rds')
...
#   saveRDS('analyses/EEG/results/Nakagawa2017_R2_EEG_genderAgr_MiniNor_400_900_lateral_lmerTest.rds')

# Calculate 95% confidence intervals of fixed effects
lme4::confint.merMod(
  EEG_genderAgr_MiniNor_400_900_lateral_lmerTest, method = 'Wald',
  ...
  saveRDS('analyses/EEG/results/confint_EEG_genderAgr_MiniNor_400_900_lateral_lmerTest.rds')

# Save random effects
lme4::ranef(EEG_genderAgr_MiniNor_400_900_lateral_lmerTest) %>%
  saveRDS('analyses/EEG/results/ranef_EEG_genderAgr_MiniNor_400_900_lateral_lmerTest.rds')
