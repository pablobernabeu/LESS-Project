...
saveRDS(EEG_DOM_MiniNor_200_500_midline_lmerTest, 
        'analyses/results/EEG_DOM_MiniNor_200_500_midline_lmerTest.rds')
...
summary(EEG_DOM_MiniNor_200_500_midline_lmerTest, ddf <- 'Satterthwaite') %>%
  saveRDS('analyses/results/Satterthwaite_summary_EEG_DOM_MiniNor_200_500_midline_lmerTest.rds')
...
#   saveRDS('analyses/results/Nakagawa2017_R2_EEG_DOM_MiniNor_200_500_midline_lmerTest.rds')
...
lme4::confint.merMod(
  ...
  saveRDS('analyses/results/confint_EEG_DOM_MiniNor_200_500_midline_lmerTest.rds')

# Save random effects
lme4::ranef(EEG_DOM_MiniNor_200_500_midline_lmerTest) %>%
  saveRDS('analyses/results/ranef_EEG_DOM_MiniNor_200_500_midline_lmerTest.rds')
