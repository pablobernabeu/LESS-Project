...
saveRDS(EEG_genderAgr_MiniEng_200_500_midline_lmerTest, 
        'EEG/analyses/results/EEG_genderAgr_MiniEng_200_500_midline_lmerTest.rds')
...
summary(EEG_genderAgr_MiniEng_200_500_midline_lmerTest, ddf = 'Satterthwaite') %>%
  saveRDS('EEG/analyses/results/Satterthwaite_summary_EEG_genderAgr_MiniEng_200_500_midline_lmerTest.rds')
...
#   saveRDS('EEG/analyses/results/Nakagawa2017_R2_EEG_genderAgr_MiniEng_200_500_midline_lmerTest.rds')
...
lme4::confint.merMod(
  ...
  saveRDS('EEG/analyses/results/confint_EEG_genderAgr_MiniEng_200_500_midline_lmerTest.rds')

# Save random effects
lme4::ranef(EEG_genderAgr_MiniEng_200_500_midline_lmerTest) %>%
  saveRDS('EEG/analyses/results/ranef_EEG_genderAgr_MiniEng_200_500_midline_lmerTest.rds')
