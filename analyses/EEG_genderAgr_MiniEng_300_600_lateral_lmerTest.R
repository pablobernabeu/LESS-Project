...
#         'data/final data/EEG_genderAgr_MiniEng_300_600_lateral_data.rds')
...
saveRDS(EEG_genderAgr_MiniEng_300_600_lateral_lmerTest, 
        'analyses/results/EEG_genderAgr_MiniEng_300_600_lateral_lmerTest.rds')

# Calculate p values using Kenward-Roger method (Luke, 2017; 
# https://doi.org/10.3758/s13428-016-0809-y)
summary(EEG_genderAgr_MiniEng_300_600_lateral_lmerTest, ddf <- 'Kenward-Roger') %>%
  saveRDS('analyses/results/KR_summary_EEG_genderAgr_MiniEng_300_600_lateral_lmerTest.rds')
...
#   saveRDS('analyses/results/Nakagawa2017_R2_EEG_genderAgr_MiniEng_300_600_lateral_lmerTest.rds')

# Calculate 95% confidence intervals of fixed effects
lme4::confint.merMod(
  EEG_genderAgr_MiniEng_300_600_lateral_lmerTest, method <- 'profile',
  ...
  saveRDS('analyses/results/confint_EEG_genderAgr_MiniEng_300_600_lateral_lmerTest.rds')

# Save random effects
lme4::ranef(EEG_genderAgr_MiniEng_300_600_lateral_lmerTest) %>%
  saveRDS('analyses/results/ranef_EEG_genderAgr_MiniEng_300_600_lateral_lmerTest.rds')
