...
# Changing the values in row 2, columns 9 to 14 to include Q_L1_acq by converting it into a character
...
LHQ3_results_raw[2, 9:14] <- lapply(LHQ3_results_raw[2, 9:14], function(x) {
  ...
  paste(Q_L1_acq, x, sep = ", ")
})

#continuing as outlined

LHQ3_results_raw[1, 15] <- "L2 Acquisition"
...
LHQ3_results_raw[2, 15:20] <- lapply(LHQ3_results_raw[2, 15:20], function(x) {
  x <- as.character(x)
  paste(Q_L2_acq, x, sep = ", ")
})

LHQ3_results_raw[1, 21] <- "L3 Acquisition"
...
LHQ3_results_raw[2, 21:26] <- lapply(LHQ3_results_raw[2, 21:26], function(x) {
  x <- as.character(x)
  paste(Q_L3_acq, x, sep = ", ")
})

LHQ3_results_raw[1, 27] <- "L4 Acquisition"
...
LHQ3_results_raw[1, 95] <- "Elementary school L"
...
LHQ3_results_raw[2, 95:97] <- lapply(LHQ3_results_raw[2, 95:97], function(x) {
 x <- as.character(x)
paste(Q_elementary, x, sep = ", ")
})

LHQ3_results_raw[1, 98] <- "Middle school L"
...
LHQ3_results_raw[2, 98:100] <- lapply(LHQ3_results_raw[2, 98:100], function(x) {
  x <- as.character(x)
  paste(Q_middle, x, sep = ", ")
})

LHQ3_results_raw[1, 101] <- "High school L"
...
LHQ3_results_raw[2, 101:103] <- lapply(LHQ3_results_raw[2, 101:103], function(x) {
  x <- as.character(x)
  paste(Q_highsch, x, sep = ", ")
})

LHQ3_results_raw[1, 104] <- "BA L"
