...
pattern1_S3_N300 = "^[0-9].*N300_S1_S101.txt"
print(pattern1_S3_N300)
pattern2_S3_N300 = "^[0-9].*N300_S1_S102.txt"
pattern3_S3_N300 = "^[0-9].*N300_S2_S102.txt"
pattern4_S3_N300 = "^[0-9].*N300_S2_S102.txt"

#creation of two tables on the property of gender, one for the Grammatical and one for the Ungrammatical condition
file_listS101_S3_N300 <- list.files(pattern = pattern1_S3_N300)
print(file_listS101_S3_N300)

file_listS102_S3_N300 <- list.files(pattern = pattern2_S3_N300)
print(file_listS102_S3_N300)


#creation of two tables on the property of differential object marking, one for the Grammatical and one for the Ungrammatical condition
file_listS103_S3_N300 <- list.files(pattern = pattern3_S3_N300)
print(file_listS103_S3_N300)

file_listS104_S3_N300 <- list.files(pattern = pattern4_S3_N300)
print(file_listS104_S3_N300)


#reading the tables
data_listS101_S3_N300 <- lapply(file_listS101_S3_N300, function(file) {
  read.table(file, header = TRUE, sep = "")
})

data_listS102_S3_N300 <- lapply(file_listS102_S3_N300, function(file) {
  read.table(file, header = TRUE, sep = "")
})

data_listS103_S3_N300 <- lapply(file_listS103_S3_N300, function(file) {
  read.table(file, header = TRUE, sep = "")
})

data_listS104_S3_N300 <- lapply(file_listS104_S3_N300, function(file) {
  read.table(file, header = TRUE, sep = "")
})

#Checking dimensions of the data frames

str(data_listS101_S3_N300[[1]])
str(data_listS102_S3_N300[[1]])
str(data_listS103_S3_N300[[1]])
str(data_listS104_S3_N300[[1]])


#checking if rows are missing and removing them

if (all(sapply(data_listS101_S3_N300, nrow) > 0)) {
  S3_S101_N300 <- Reduce(function(...) merge(..., all = TRUE), data_listS101_S3_N300)
  View(S3_S101_N300)
} else {
  print("Some data frames in data_listS101_S3_N300 have no rows.")
}


if (all(sapply(data_listS102_S3_N300, nrow) > 0)) {
  S3_S102_N300 <- Reduce(function(...) merge(..., all = TRUE), data_listS102_S3_N300)
  View(S3_S102_N300)
} else {
  print("Some data frames in data_list2_S3_N300 have no rows.")
}


if (all(sapply(data_listS103_S3_N300, nrow) > 0)) {
  S3_S103_N300 <- Reduce(function(...) merge(..., all = TRUE), data_listS103_S3_N300)
  View(S3_S103_N300)
} else {
  print("Some data frames in data_listS101_S3_N300 have no rows.")
}
...
if (all(sapply(data_listS104_S3_N300, nrow) > 0)) {
  S3_S104_N300 <- Reduce(function(...) merge(..., all = TRUE), data_listS104_S3_N300)
  View(S3_S104_N300)
} else {
  print("Some data frames in data_listS101_S3_N300 have no rows.")
}
...
S3_GEN_Grammatical_N300 <- do.call(rbind, data_listS101_S3_N300)
str(S3_GEN_Grammatical_N300)
head(S3_GEN_Grammatical_N300)

S3_GEN_Ungrammatical_N300 <- do.call(rbind, data_listS102_S3_N300)
head(S3_GEN_Ungrammatical_N300)

S3_DOM_Grammatical_N300 <- do.call(rbind, data_listS103_S3_N300)
head(S3_DOM_Grammatical_N300)

S3_DOM_Ungrammatical_N300 <- do.call(rbind, data_listS104_S3_N300)
head(S3_DOM_Ungrammatical_N300)

#converting the tables into data frames
S3_GEN_Grammatical_N300 <- as.data.frame(S3_GEN_Grammatical_N300)
S3_GEN_Ungrammatical_N300 <- as.data.frame(S3_GEN_Ungrammatical_N300)
S3_DOM_Grammatical_N300 <- as.data.frame(S3_DOM_Grammatical_N300)
S3_DOM_Ungrammatical_N300 <- as.data.frame(S3_DOM_Ungrammatical_N300)

#testing dataframes
View(S3_GEN_Grammatical_N300)
View(S3_GEN_Ungrammatical_N300)
View(S3_DOM_Grammatical_N300)
View(S3_DOM_Grammatical_N300)

#the decimal point is a comma in BrainVision analyzer export files
#converting commas to periods in the dataframe
S3_GEN_Grammatical_N300 <- S3_GEN_Grammatical_N300 %>% 
  mutate(across(everything(), ~ gsub(",",".",., fixed = TRUE)))
S3_GEN_Ungrammatical_N300 <- S3_GEN_Ungrammatical_N300 %>% 
  mutate(across(everything(), ~ gsub(",",".",., fixed = TRUE)))
S3_DOM_Grammatical_N300 <- S3_DOM_Grammatical_N300 %>% 
  mutate(across(everything(), ~ gsub(",",".",., fixed = TRUE)))
S3_DOM_Ungrammatical_N300 <- S3_DOM_Ungrammatical_N300 %>% 
  mutate(across(everything(), ~ gsub(",",".",., fixed = TRUE)))

#Converting columns to numeric if necessary
S3_GEN_Grammatical_N300 <-S3_GEN_Grammatical_N300 %>% mutate(across(everything(), as.numeric))
S3_GEN_Ungrammatical_N300 <- S3_GEN_Ungrammatical_N300 %>% mutate(across(everything(), as.numeric))
S3_DOM_Grammatical_N300 <-S3_DOM_Grammatical_N300 %>% mutate(across(everything(), as.numeric))
S3_DOM_Ungrammatical_N300 <- S3_DOM_Ungrammatical_N300 %>% mutate(across(everything(), as.numeric))
...
left_medial_Grammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Grammatical_N300[, c("T7.Average", "C3.Average", "CP5.Average")], na.rm = TRUE)
left_medial_Grammatical_S3_GEN_N300 <- mean(left_medial_Grammatical_row_means_S3_GEN_N300, na.rm = TRUE)

right_medial_Grammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Grammatical_N300 [, c("C4.Average", "T8.Average", "CP6.Average")], na.rm = TRUE)
right_medial_Grammatical_S3_GEN_N300 <- mean(right_medial_Grammatical_row_means_S3_GEN_N300, na.rm = TRUE)

left_anterior_Grammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Grammatical_N300[, c("Fp1.Average", "F3.Average", "F7.Average", "FT9.Average", "FC5.Average")], na.rm = TRUE)
left_anterior_Grammatical_S3_GEN_N300 <- mean(left_anterior_Grammatical_row_means_S3_GEN_N300, na.rm = TRUE)

right_anterior_Grammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Grammatical_N300[, c("Fp2.Average", "F4.Average", "F8.Average", "FC6.Average", "FT10.Average")], na.rm = TRUE)
right_anterior_Grammatical_S3_GEN_N300 <- mean(right_anterior_Grammatical_row_means_S3_GEN_N300, na.rm = TRUE)

left_posterior_Grammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Grammatical_N300 [, c("P7.Average", "P3.Average", "O1.Average")], na.rm = TRUE)
left_posterior_Grammatical_S3_GEN_N300 <- mean(left_posterior_Grammatical_row_means_S3_GEN_N300, na.rm = TRUE) 

right_posterior_Grammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Grammatical_N300 [,c ("P4.Average", "P8.Average", "O2.Average")], na.rm = TRUE)
right_posterior_Grammatical_S3_GEN_N300 <- mean(right_posterior_Grammatical_row_means_S3_GEN_N300, na.rm = TRUE)

midline_anterior_Grammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Grammatical_N300 [, c ("Fz.Average", "FC1.Average", "FC2.Average")], na.rm = TRUE)
midline_anterior_Grammatical_S3_GEN_N300 <- mean(midline_anterior_Grammatical_row_means_S3_GEN_N300, na.rm = TRUE)

midline_medial_Grammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Grammatical_N300 [,c ("Cz.Average", "CP1.Average", "CP2.Average")], na.rm = TRUE)
midline_medial_Grammatical_S3_GEN_N300 <- mean(midline_medial_Grammatical_row_means_S3_GEN_N300, na.rm = TRUE)

midline_posterior_Grammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Grammatical_N300[,c ("Pz.Average", "Oz.Average")], na.rm = TRUE)
midline_posterior_Grammatical_S3_GEN_N300 <- mean(midline_posterior_Grammatical_row_means_S3_GEN_N300, na.rm = TRUE)


# For Gender in the Ungrammatical condition

left_medial_Ungrammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Ungrammatical_N300[, c("T7.Average", "C3.Average", "CP5.Average")], na.rm = TRUE)
left_medial_Ungrammatical_S3_GEN_N300 <- mean(left_medial_Ungrammatical_row_means_S3_GEN_N300, na.rm = TRUE)

right_medial_Ungrammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Ungrammatical_N300 [, c("C4.Average", "T8.Average", "CP6.Average")], na.rm = TRUE)
right_medial_Ungrammatical_S3_GEN_N300 <- mean(right_medial_Ungrammatical_row_means_S3_GEN_N300, na.rm = TRUE)

left_anterior_Ungrammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Ungrammatical_N300[, c("Fp1.Average", "F3.Average", "F7.Average", "FT9.Average", "FC5.Average")], na.rm = TRUE)
left_anterior_Ungrammatical_S3_GEN_N300 <- mean(left_anterior_Ungrammatical_row_means_S3_GEN_N300, na.rm = TRUE)

right_anterior_Ungrammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Ungrammatical_N300[, c("Fp2.Average", "F4.Average", "F8.Average", "FC6.Average", "FT10.Average")], na.rm = TRUE)
right_anterior_Ungrammatical_S3_GEN_N300 <- mean(right_anterior_Ungrammatical_row_means_S3_GEN_N300, na.rm = TRUE)

left_posterior_Ungrammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Ungrammatical_N300 [, c("P7.Average", "P3.Average", "O1.Average")], na.rm = TRUE)
left_posterior_Ungrammatical_S3_GEN_N300 <- mean(left_posterior_Ungrammatical_row_means_S3_GEN_N300, na.rm = TRUE) 

right_posterior_Ungrammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Ungrammatical_N300 [,c ("P4.Average", "P8.Average", "O2.Average")], na.rm = TRUE)
right_posterior_Ungrammatical_S3_GEN_N300 <- mean(right_posterior_Ungrammatical_row_means_S3_GEN_N300, na.rm = TRUE)

midline_anterior_Ungrammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Ungrammatical_N300 [, c ("Fz.Average", "FC1.Average", "FC2.Average")], na.rm = TRUE)
midline_anterior_Ungrammatical_S3_GEN_N300 <- mean(midline_anterior_Ungrammatical_row_means_S3_GEN_N300, na.rm = TRUE)

midline_medial_Ungrammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Ungrammatical_N300 [,c ("Cz.Average", "CP1.Average", "CP2.Average")], na.rm = TRUE)
midline_medial_Ungrammatical_S3_GEN_N300 <- mean(midline_medial_Ungrammatical_row_means_S3_GEN_N300, na.rm = TRUE)

midline_posterior_Ungrammatical_row_means_S3_GEN_N300 <- rowMeans(S3_GEN_Ungrammatical_N300[,c ("Pz.Average", "Oz.Average")], na.rm = TRUE)
midline_posterior_Ungrammatical_S3_GEN_N300 <- mean(midline_posterior_Ungrammatical_row_means_S3_GEN_N300, na.rm = TRUE)


# Print results
print(left_medial_Ungrammatical_S3_GEN_N300)
print(left_medial_Grammatical_S3_GEN_N300)
print(right_medial_Ungrammatical_S3_GEN_N300)
print(right_medial_Grammatical_S3_GEN_N300)
print(left_anterior_Ungrammatical_S3_GEN_N300)
print(left_anterior_Grammatical_S3_GEN_N300)
print(right_anterior_Ungrammatical_S3_GEN_N300)
print(right_anterior_Grammatical_S3_GEN_N300)
print(left_posterior_Ungrammatical_S3_GEN_N300)
print(left_posterior_Grammatical_S3_GEN_N300)
print(right_posterior_Ungrammatical_S3_GEN_N300)
print(right_posterior_Grammatical_S3_GEN_N300)
print(midline_anterior_Ungrammatical_S3_GEN_N300)
print(midline_anterior_Grammatical_S3_GEN_N300)
print(midline_medial_Ungrammatical_S3_GEN_N300)
print(midline_medial_Grammatical_S3_GEN_N300)
print(midline_posterior_Ungrammatical_S3_GEN_N300)
print(midline_posterior_Grammatical_S3_GEN_N300)

# For Differential Object Marking

# For Differential Object Marking in the Grammatical condition

left_medial_Grammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Grammatical_N300[, c("T7.Average", "C3.Average", "CP5.Average")], na.rm = TRUE)
left_medial_Grammatical_S3_DOM_N300 <- mean(left_medial_Grammatical_row_means_S3_DOM_N300, na.rm = TRUE)

right_medial_Grammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Grammatical_N300 [, c("C4.Average", "T8.Average", "CP6.Average")], na.rm = TRUE)
right_medial_Grammatical_S3_DOM_N300 <- mean(right_medial_Grammatical_row_means_S3_DOM_N300, na.rm = TRUE)

left_anterior_Grammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Grammatical_N300[, c("Fp1.Average", "F3.Average", "F7.Average", "FT9.Average", "FC5.Average")], na.rm = TRUE)
left_anterior_Grammatical_S3_DOM_N300 <- mean(left_anterior_Grammatical_row_means_S3_DOM_N300, na.rm = TRUE)

right_anterior_Grammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Grammatical_N300[, c("Fp2.Average", "F4.Average", "F8.Average", "FC6.Average", "FT10.Average")], na.rm = TRUE)
right_anterior_Grammatical_S3_DOM_N300 <- mean(right_anterior_Grammatical_row_means_S3_DOM_N300, na.rm = TRUE)

left_posterior_Grammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Grammatical_N300 [, c("P7.Average", "P3.Average", "O1.Average")], na.rm = TRUE)
left_posterior_Grammatical_S3_DOM_N300 <- mean(left_posterior_Grammatical_row_means_S3_DOM_N300, na.rm = TRUE) 

right_posterior_Grammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Grammatical_N300 [,c ("P4.Average", "P8.Average", "O2.Average")], na.rm = TRUE)
right_posterior_Grammatical_S3_DOM_N300 <- mean(right_posterior_Grammatical_row_means_S3_DOM_N300, na.rm = TRUE)

midline_anterior_Grammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Grammatical_N300 [, c ("Fz.Average", "FC1.Average", "FC2.Average")], na.rm = TRUE)
midline_anterior_Grammatical_S3_DOM_N300 <- mean(midline_anterior_Grammatical_row_means_S3_DOM_N300, na.rm = TRUE)

midline_medial_Grammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Grammatical_N300 [,c ("Cz.Average", "CP1.Average", "CP2.Average")], na.rm = TRUE)
midline_medial_Grammatical_S3_DOM_N300 <- mean(midline_medial_Grammatical_row_means_S3_DOM_N300, na.rm = TRUE)

midline_posterior_Grammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Grammatical_N300[,c ("Pz.Average", "Oz.Average")], na.rm = TRUE)
midline_posterior_Grammatical_S3_DOM_N300 <- mean(midline_posterior_Grammatical_row_means_S3_DOM_N300, na.rm = TRUE)


# For Differential Object Marking in the Ungrammatical condition

left_medial_Ungrammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Ungrammatical_N300[, c("T7.Average", "C3.Average", "CP5.Average")], na.rm = TRUE)
left_medial_Ungrammatical_S3_DOM_N300 <- mean(left_medial_Ungrammatical_row_means_S3_DOM_N300, na.rm = TRUE)

right_medial_Ungrammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Ungrammatical_N300 [, c("C4.Average", "T8.Average", "CP6.Average")], na.rm = TRUE)
right_medial_Ungrammatical_S3_DOM_N300 <- mean(right_medial_Ungrammatical_row_means_S3_DOM_N300, na.rm = TRUE)

left_anterior_Ungrammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Ungrammatical_N300[, c("Fp1.Average", "F3.Average", "F7.Average", "FT9.Average", "FC5.Average")], na.rm = TRUE)
left_anterior_Ungrammatical_S3_DOM_N300 <- mean(left_anterior_Ungrammatical_row_means_S3_DOM_N300, na.rm = TRUE)

right_anterior_Ungrammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Ungrammatical_N300[, c("Fp2.Average", "F4.Average", "F8.Average", "FC6.Average", "FT10.Average")], na.rm = TRUE)
right_anterior_Ungrammatical_S3_DOM_N300 <- mean(right_anterior_Ungrammatical_row_means_S3_DOM_N300, na.rm = TRUE)

left_posterior_Ungrammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Ungrammatical_N300 [, c("P7.Average", "P3.Average", "O1.Average")], na.rm = TRUE)
left_posterior_Ungrammatical_S3_DOM_N300 <- mean(left_posterior_Ungrammatical_row_means_S3_DOM_N300, na.rm = TRUE) 

right_posterior_Ungrammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Ungrammatical_N300 [,c ("P4.Average", "P8.Average", "O2.Average")], na.rm = TRUE)
right_posterior_Ungrammatical_S3_DOM_N300 <- mean(right_posterior_Ungrammatical_row_means_S3_DOM_N300, na.rm = TRUE)

midline_anterior_Ungrammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Ungrammatical_N300 [, c ("Fz.Average", "FC1.Average", "FC2.Average")], na.rm = TRUE)
midline_anterior_Ungrammatical_S3_DOM_N300 <- mean(midline_anterior_Ungrammatical_row_means_S3_DOM_N300, na.rm = TRUE)

midline_medial_Ungrammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Ungrammatical_N300 [,c ("Cz.Average", "CP1.Average", "CP2.Average")], na.rm = TRUE)
midline_medial_Ungrammatical_S3_DOM_N300 <- mean(midline_medial_Ungrammatical_row_means_S3_DOM_N300, na.rm = TRUE)

midline_posterior_Ungrammatical_row_means_S3_DOM_N300 <- rowMeans(S3_DOM_Ungrammatical_N300[,c ("Pz.Average", "Oz.Average")], na.rm = TRUE)
midline_posterior_Ungrammatical_S3_DOM_N300 <- mean(midline_posterior_Ungrammatical_row_means_S3_DOM_N300, na.rm = TRUE)


# Print results
print(left_medial_Ungrammatical_S3_DOM_N300)
print(left_medial_Grammatical_S3_DOM_N300)
print(right_medial_Ungrammatical_S3_DOM_N300)
print(right_medial_Grammatical_S3_DOM_N300)
print(left_anterior_Ungrammatical_S3_DOM_N300)
print(left_anterior_Grammatical_S3_DOM_N300)
print(right_anterior_Ungrammatical_S3_DOM_N300)
print(right_anterior_Grammatical_S3_DOM_N300)
print(left_posterior_Ungrammatical_S3_DOM_N300)
print(left_posterior_Grammatical_S3_DOM_N300)
print(right_posterior_Ungrammatical_S3_DOM_N300)
print(right_posterior_Grammatical_S3_DOM_N300)
print(midline_anterior_Ungrammatical_S3_DOM_N300)
print(midline_anterior_Grammatical_S3_DOM_N300)
print(midline_medial_Ungrammatical_S3_DOM_N300)
print(midline_medial_Grammatical_S3_DOM_N300)
print(midline_posterior_Ungrammatical_S3_DOM_N300)
print(midline_posterior_Grammatical_S3_DOM_N300)
...
pattern3_S3_N600 = "^[0-9].*N600_S2_S102.txt"
