...
path = "Raw data/EEG/Session 2/Export/"
...
merged_data$Participant_number = as.character(merged_data$Participant_number)

Session2_Background = full_join(merged_data, Session2_melted_data, by = "Participant_number")
