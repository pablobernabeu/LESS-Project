...
Session4_GenderAgreement_violation_interest_list = lapply(1:length(Session4_GenderAgreement_violation_interest),
                                               function(x) { read.table(Session4_GenderAgreement_violation_interest [x], header=FALSE) } )

Session4_GenderAgreement_ancillary_violation_list = lapply(1:length(Session4_GenderAgreement_ancillary_violation),
