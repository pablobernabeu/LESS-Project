...
ASRT_2_extra = read_csv(file.path(path, "wbij5_ASRT_Stroop.csv"))
ASRT_3_extra = read_csv(file.path(path, "xqls8_ASRT_Stroop.csv"))

# Merge the data frames
ASRT_1 = bind_rows(ASRT_1, ASRT_1_extra)
ASRT_2 = bind_rows(ASRT_2, ASRT_2_extra)
ASRT_3 = bind_rows(ASRT_3, ASRT_3_extra)
