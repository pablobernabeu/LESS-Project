...
# Definir el path
path_to_ASRT <- "C:/Users/stpis0397/OneDrive - UiT Office 365/LESS-Project-with-RAs-2/Gorilla/data_exp_143587-v32"
...
ASRT_2_extra <- read_csv(file.path(path_to_ASRT, "wbij5_ASRT_STROOP.csv"))
ASRT_3_extra <- read_csv(file.path(path_to_ASRT, "xqls8_ASRT_STROOP.csv"))
