...
#SBATCH --job-name=temp_EEG_data_descriptives
#SBATCH --partition=bigmem
#SBATCH --mem=200G
#SBATCH --ntasks=1
#SBATCH --time=7-0:00:00
#SBATCH -o temp_EEG_data_descriptives.out 
...
CONTAINER_R_SCRIPT="/project_root/data/temp_EEG data descriptives.R"
# The log file for the R script's output, relative to your job submission directory
R_SCRIPT_LOG="temp_EEG_data_descriptives.log"

# --- Main Command: Running R script inside Singularity via SLURM ---
# The standard output and standard error from *this* command will go to the SLURM -o file (temp_EEG_data_descriptives.out).
# The output *from the R script itself* will be redirected to temp_EEG_data_descriptives.log.
singularity exec \
